...
jest.mock('../../../components/pokemonCard/pokemonCard', () => (props: any) => (
  <div data-testid="pokemon-card">{props.data.name}</div>
));
jest.mock('../../../components/filter/filter', () => (props: any) => (
  <div>Filter</div>
));
...
describe('HomePage Component', () => {
  ...
  it('shows loading indicator when loading', () => {
    ...
    render(
      <PokemonContext.Provider
        value={{ ...mockContextValue, state: loadingState } as any}
      >
        <HomePage />
      </PokemonContext.Provider>
    );
  ...
  it('shows no data found message when pokemon list is empty', () => {
    ...
    render(
      <PokemonContext.Provider
        value={{ ...mockContextValue, state: emptyState } as any}
      >
        <HomePage />
      </PokemonContext.Provider>
    );
